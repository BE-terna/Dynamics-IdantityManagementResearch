...
$createUserBody = @{
    'UserID' = 'testIDM';
    'Alias' = 'name@tenantdomain.onmicrosoft.com';
...
$createdEntityUrl # /PersonUsers(UserId='first.last',PartyNumber='000015474',ValidFrom=2020-12-31T23:00:00Z)

# get specific mapping 
$personUserDetail = Invoke-RestMethod -Method Get "$d365foPrefix/PersonUsers(UserId='first.last',PartyNumber='000015474',ValidFrom=2020-12-31T23:00:00Z)" @restParams
$personUserDetail
...
$null = Invoke-RestMethod -Method Patch "$d365foPrefix/PersonUsers(UserId='first.last',PartyNumber='000015474',ValidFrom=2020-12-31T23:00:00Z)" -Body (ConvertTo-Json $personUserCloseBody) -ContentType application/json @restParams

# remove user-worker mapping
$null = Invoke-RestMethod -Method Delete "$d365foPrefix/PersonUsers(UserId='first.last',PartyNumber='000015474',ValidFrom=2020-12-31T23:00:00Z)"  @restParams
